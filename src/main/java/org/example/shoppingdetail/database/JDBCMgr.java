package org.example.shoppingdetail.database;
    ...
    public static Connection getConnection() {
        ...
        if (conn == null) {
            try {
                ...
                conn = DriverManager.getConnection("jdbc:h2:tcp:C:/workspace/naverpay-local/naverpay-clone-project/NaverPayDB", "sa", "");
